...
####anoxic-oxic-anoxic within a summer x all years repeated
#pull in SSS file (currently not on EDI)
inflowoxy<-read.csv("inputs/Calc_HOX_flow_DO_ANOXIC_20200903.csv", header=T) %>%
...
write.csv(SSS_inflowALL, "inputs/FCR_SSS_inflow_2013_2019_20200903_ANOXIC_OXIC_ANOXIC_allfractions_2DOCpools.csv", row.names = FALSE)
